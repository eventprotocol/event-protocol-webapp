...
import AcknowledgeCancelButton from "./acknowledge-cancel-form.js"
...
class IncreaseSecurityDeposit extends Component{
  ...
  render(){
    if (this.props.drizzleStatus.initialized == true && this.props.contracts.EventToken != undefined){
      return(
      <div align = "center">
        <AcknowledgeCancelButton contract="EventContract" method="acknowledgeCancelRequest" labels={[" val"]} sendArgs={{from: this.props.accounts[0], gas:1000000}}/>
      </div>
