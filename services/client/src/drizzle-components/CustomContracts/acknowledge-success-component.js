...
import AcknowledgeSuccessButton from "./acknowledge-success-form.js"
...
class IncreaseSecurityDeposit extends Component{
  ...
  render(){
    if (this.props.drizzleStatus.initialized == true && this.props.contracts.EventToken != undefined){
      return(
      <div align = "center">
        <AcknowledgeSuccessButton contract="EventContract" method="completeResolve" labels={[" val"]} sendArgs={{from: this.props.accounts[0], gas:1000000}}/>
      </div>
